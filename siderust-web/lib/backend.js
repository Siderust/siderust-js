...
export function ensureInit() {
  if (!wasm) {
    throw new Error('@siderust/siderust-web: call init() before using any function');
  }
}
...
NativeObserver.roqueDeLasMuchachos = () => { ensureInit(); return wasm.Observer.roqueDeLasMuchachos(); };
NativeObserver.elParanal           = () => { ensureInit(); return wasm.Observer.elParanal(); };
NativeObserver.maunaKea            = () => { ensureInit(); return wasm.Observer.maunaKea(); };
NativeObserver.laSilla             = () => { ensureInit(); return wasm.Observer.laSilla(); };

export function NativeStar(name, distanceLy, massSolar, radiusSolar, luminositySolar, raDeg, decDeg) {
  ensureInit();
  return new wasm.Star(name, distanceLy, massSolar, radiusSolar, luminositySolar, raDeg, decDeg);
}

NativeStar.catalog = (name) => { ensureInit(); return wasm.Star.catalog(name); };

// ── Bodies / Stars ────────────────────────────────────────────────

export function getPlanet(name) { ensureInit(); return wasm.getPlanet(name); }
export function listBodies() { ensureInit(); return wasm.listBodies(); }
export function listCatalogStars() { ensureInit(); return wasm.listCatalogStars(); }
...
export function directionToHorizontal(polarDeg, azimuthDeg, srcFrame, jd, observer) {
  ensureInit();
  return wasm.directionToHorizontal(polarDeg, azimuthDeg, srcFrame, jd, observer);
}
export function geodeticToEcef(observer) { ensureInit(); return wasm.geodeticToEcef(observer); }
...
export function cartesianMagnitude(x, y, z) { ensureInit(); return wasm.cartesianMagnitude(x, y, z); }
...
export function vsop87Heliocentric(body, jd) { ensureInit(); return wasm.vsop87Heliocentric(body, jd); }
export function vsop87Barycentric(body, jd) { ensureInit(); return wasm.vsop87Barycentric(body, jd); }
export function vsop87SunBarycentric(jd) { ensureInit(); return wasm.vsop87SunBarycentric(jd); }
export function vsop87EarthBarycentric(jd) { ensureInit(); return wasm.vsop87EarthBarycentric(jd); }
export function vsop87EarthHeliocentric(jd) { ensureInit(); return wasm.vsop87EarthHeliocentric(jd); }
export function vsop87MoonGeocentric(jd) { ensureInit(); return wasm.vsop87MoonGeocentric(jd); }
...
export function orbitalPeriodDays(name) { ensureInit(); return wasm.orbitalPeriodDays(name); }

// ── Body events ───────────────────────────────────────────────────

export function bodyAltitudeAt(body, observer, mjd) { ensureInit(); return wasm.bodyAltitudeAt(body, observer, mjd); }
export function bodyAzimuthAt(body, observer, mjd) { ensureInit(); return wasm.bodyAzimuthAt(body, observer, mjd); }
...
export function bodyAboveThreshold(body, observer, startMjd, endMjd, thresholdDeg) {
  ensureInit();
  return wasm.bodyAboveThreshold(body, observer, startMjd, endMjd, thresholdDeg);
}
export function bodyBelowThreshold(body, observer, startMjd, endMjd, thresholdDeg) {
  ensureInit();
  return wasm.bodyBelowThreshold(body, observer, startMjd, endMjd, thresholdDeg);
}
export function bodyAzimuthCrossings(body, observer, startMjd, endMjd, bearingDeg) {
  ensureInit();
  return wasm.bodyAzimuthCrossings(body, observer, startMjd, endMjd, bearingDeg);
}
...
export function starAltitudeAt(star, observer, mjd) { ensureInit(); return wasm.starAltitudeAt(star, observer, mjd); }
export function starAzimuthAt(star, observer, mjd) { ensureInit(); return wasm.starAzimuthAt(star, observer, mjd); }
...
export function starAboveThreshold(star, observer, startMjd, endMjd, thresholdDeg) {
  ensureInit();
  return wasm.starAboveThreshold(star, observer, startMjd, endMjd, thresholdDeg);
}
export function starBelowThreshold(star, observer, startMjd, endMjd, thresholdDeg) {
  ensureInit();
  return wasm.starBelowThreshold(star, observer, startMjd, endMjd, thresholdDeg);
}
export function starAzimuthCrossings(star, observer, startMjd, endMjd, bearingDeg) {
  ensureInit();
  return wasm.starAzimuthCrossings(star, observer, startMjd, endMjd, bearingDeg);
}
...
export function moonPhase(jd) { ensureInit(); return wasm.moonPhase(jd); }
export function moonPhaseTopocentric(jd, observer) { ensureInit(); return wasm.moonPhaseTopocentric(jd, observer); }
export function findPhaseEvents(startMjd, endMjd) { ensureInit(); return wasm.findPhaseEvents(startMjd, endMjd); }
...
export function version() { ensureInit(); return wasm.version(); }
