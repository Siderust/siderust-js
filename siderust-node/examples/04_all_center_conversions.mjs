...
const { transformPositionCenter, cartesianMagnitude } = require(
...
const pBary = { x: 0.4, y: -0.1, z: 1.2 };

// Convert to other centers for use as sources
const pHelio = transformPositionCenter(
  pBary.x,
  pBary.y,
  pBary.z,
  'Barycentric',
...
const step1 = transformPositionCenter(
  pHelio.x,
  pHelio.y,
  pHelio.z,
  'Heliocentric',
