...
const selfSep = angularSeparation(
  polarisDec,
  polarisRA,
  polarisDec,
  polarisRA,
...
console.log(
  `Polaris cartesian: (${polarisCart.x.toFixed(4)}, ${polarisCart.y.toFixed(4)}, ${polarisCart.z.toFixed(4)})`,
);
console.log(
  `Sirius  cartesian: (${siriusCart.x.toFixed(4)}, ${siriusCart.y.toFixed(4)}, ${siriusCart.z.toFixed(4)})`,
);
console.log(`  angle via acos(dot) = ${angleRad.toFixed(6)} rad = ${angleDeg.toFixed(4)}°`);
console.log(`  angularSeparation   = ${sep.toFixed(4)}°`);
console.log(
  `  Difference          = ${Math.abs(angleDeg - sep).toExponential(2)}°  (near machine epsilon)`,
);
...
console.log(
  `Earth cartesian: (${earthCart.x.toFixed(4)}, ${earthCart.y.toFixed(4)}, ${earthCart.z.toFixed(4)})`,
);
console.log(
  `Mars  cartesian: (${marsCart.x.toFixed(4)}, ${marsCart.y.toFixed(4)}, ${marsCart.z.toFixed(4)})`,
);
...
console.log(
  `  Mars − Earth vector: (${diff.x.toFixed(4)}, ${diff.y.toFixed(4)}, ${diff.z.toFixed(4)})`,
);
